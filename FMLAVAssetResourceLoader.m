...
#import "FMLAVAssetResourceLoader.h"
#import <MobileCoreServices/MobileCoreServices.h>
#import <CommonCrypto/CommonDigest.h>

@interface FMLAVAssetResourceLoader ()
...
@implementation FMLAVAssetResourceLoader
...
- (void)setOriginURL:(NSURL *)originURL pathExtension:(NSString *)pathExtension;
{
    ...
    [self restoreState];
    self.md5Key = [FMLAVAssetResourceLoader md5StringFromString:_originURL.absoluteString];
